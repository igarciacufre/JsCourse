<script>
    var att_config = {
        ...
        // Dimensions of Image: 400px wide x 500px high.
    ...
    adobe.target.trackEvent({
        "mbox" : "pop-up-display-test",
        "params": {
            "profile.test-popUpSeen": "true"
        }
    });
        ...
        var title = null != att_config.title && att_config.title ? att_config.title : "",
            ...
            '\n<img src="http://res.e.stark.dk/res/starkgr_mkt_prod1/67087565b17bc060f655579a54d5d3719ac5c70a6c89a92a11a658a519ee2366.png" class="att_topimage"/>' +
